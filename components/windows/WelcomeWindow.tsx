        ...
        >
            <div className="flex flex-col items-center gap-3 text-center">
                ...
                <div className="flex gap-3 mt-4 w-full justify-center px-2">
                    ...
                    <button className="flex items-center gap-2 rounded-full border-2 border-black px-4 py-2 text-sm font-bold text-black transition hover:-translate-y-0.5 hover:bg-white/80 hover:shadow-lg cursor-pointer">
                        Explore
